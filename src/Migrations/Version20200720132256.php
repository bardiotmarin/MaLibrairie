 ...
 */
final class Version20200720132256 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE book ADD genre_id INT NOT NULL, ADD author_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE book DROP genre_id, DROP author_id');
    }
}
